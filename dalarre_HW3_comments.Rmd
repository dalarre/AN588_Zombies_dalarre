...
weight_age <- ggplot(d, aes(age, weight)) + geom_point(color = "darkblue") + xlab("Age") + ylab("Weight") + geom_smooth(method = lm)
weight_age 
...
*can also use qnorm just like qpois for the normal distribution. -mel*
...
*did you include the first 30? -mel*

*Great work! maybe break up your chunks a bit for organization (and to help us run it step by step) -mel*